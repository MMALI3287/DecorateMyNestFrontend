        ...
        <table className="table">
          ...
          <thead>
            <tr className=' text-base'>
              ...
              <th className='text-black bg-pink-200'>project name</th>
              <th className='text-black bg-pink-300'>Reservation</th>
              <th className='text-black bg-pink-200'>progration</th>
