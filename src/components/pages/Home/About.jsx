                ...
                <div className="grid md:grid-cols-2 justify-center mx-20">
                    <div className="md:ml-40">
                        ...
                        <div className="flex mt-4">
                            ...
                            <p className='md:text-3xl font-semibold'>sales@minimallimited.com</p>
                        </div>
                    ...
                    <div className="md:ml-40">
                        ...
                        <input placeholder="Name" type="text" name="" id="" className="border-[3px] md:px-40 py-2 mt-3" /> <br />
                        <input placeholder="Name" type="text" name="" id="" className="border-[3px] md:px-40 py-2 mt-3" /> <br />
                        <input placeholder="Email" type="email" name="" id="" className="border-[3px] md:px-40 py-2 mt-3" /> <br />
                        <input placeholder="Message" type="text" name="" id="" className="border-[3px] md:px-40 py-8 mt-3" />
                        <br />
